...
export class Backend implements backendInterface {
    ...
    async getAllContactFormsByEmail(): Promise<Array<ContactForm>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContactFormsByEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContactForm(arg0: bigint): Promise<ContactForm> {
        if (this.processError) {
            try {
